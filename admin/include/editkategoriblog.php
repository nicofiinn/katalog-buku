    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="index.php?include=katgori-blog">Kategori Blog</a></li>
  ...
  <div class="card card-info">
    <div class="card-header">
      ...
      <div class="card-tools">
        <a href="index.php?include=kategori-blog" class="btn btn-sm btn-warning float-right"><i
    ...
    <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-kategori-blog">
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <input type="text" class="form-control" name="kategori_blog" id="kategori_blog"
